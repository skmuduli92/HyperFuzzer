  ...
  assign buff[386] = 8'h80;
  assign buff[387] = 8'hf0;
  assign buff[388] = 8'h7c;
  assign buff[389] = 8'h0;
  assign buff[390] = 8'h7d;
  assign buff[391] = 8'h0;
  assign buff[392] = 8'h8c;
  assign buff[393] = 8'h82;
  assign buff[394] = 8'h74;
  assign buff[395] = 8'he0;
  assign buff[396] = 8'h2d;
  assign buff[397] = 8'hf5;
  assign buff[398] = 8'h83;
  assign buff[399] = 8'he0;
  assign buff[400] = 8'hfb;
  assign buff[401] = 8'h7a;
  assign buff[402] = 8'h0;
  assign buff[403] = 8'hb5;
  assign buff[404] = 8'h4;
  assign buff[405] = 8'h6;
  assign buff[406] = 8'hea;
  assign buff[407] = 8'hb5;
  assign buff[408] = 8'h5;
  assign buff[409] = 8'h2;
  assign buff[410] = 8'h80;
  assign buff[411] = 8'h6;
  assign buff[412] = 8'h7e;
  assign buff[413] = 8'h0;
  assign buff[414] = 8'h7f;
  assign buff[415] = 8'h0;
  assign buff[416] = 8'h80;
  assign buff[417] = 8'h10;
  assign buff[418] = 8'hc;
  assign buff[419] = 8'hbc;
  assign buff[420] = 8'h0;
  assign buff[421] = 8'h1;
  assign buff[422] = 8'hd;
  assign buff[423] = 8'hc3;
  assign buff[424] = 8'hec;
  assign buff[425] = 8'h94;
  assign buff[426] = 8'h20;
  assign buff[427] = 8'hed;
  assign buff[428] = 8'h64;
  assign buff[429] = 8'h80;
  assign buff[430] = 8'h94;
  assign buff[431] = 8'h80;
  assign buff[432] = 8'h40;
  assign buff[433] = 8'hd6;
  assign buff[434] = 8'h8e;
  assign buff[435] = 8'h80;
  assign buff[436] = 8'h2;
  assign buff[437] = 8'h0;
  assign buff[438] = 8'h62;
  assign buff[439] = 8'h75;
  assign buff[440] = 8'h82;
  assign buff[441] = 8'h0;
  assign buff[442] = 8'h22;
  wire [15:0] addr0 = addr;
  wire [15:0] addr1 = addr+1;
  wire [15:0] addr2 = addr+2;
  wire [15:0] addr3 = addr+3;
  wire [7:0] data_o0 = (addr0 < 443) ? buff[addr0] : 8'hxx;
  wire [7:0] data_o1 = (addr1 < 443) ? buff[addr1] : 8'hxx;
  wire [7:0] data_o2 = (addr2 < 443) ? buff[addr2] : 8'hxx;
  wire [7:0] data_o3 = (addr3 < 443) ? buff[addr3] : 8'hxx;
