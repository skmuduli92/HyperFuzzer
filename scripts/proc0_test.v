  // Interpreting proc0_test.ihx as an Intel formal HEX file.
  wire [7:0] buff [169:0];
  assign buff[0] = 8'h2;
  assign buff[1] = 8'h0;
  assign buff[2] = 8'h6;
  ...
  assign buff[137] = 8'h90;
  assign buff[138] = 8'h8;
  assign buff[139] = 8'h0;
  assign buff[140] = 8'he0;
  assign buff[141] = 8'hff;
  assign buff[142] = 8'hbf;
  assign buff[143] = 8'h1;
  assign buff[144] = 8'hf8;
  assign buff[145] = 8'h90;
  assign buff[146] = 8'h8;
  assign buff[147] = 8'h2;
  assign buff[148] = 8'he0;
  assign buff[149] = 8'hf5;
  assign buff[150] = 8'h80;
  assign buff[151] = 8'h90;
  assign buff[152] = 8'h8;
  assign buff[153] = 8'h3;
  assign buff[154] = 8'h74;
  assign buff[155] = 8'h8;
  assign buff[156] = 8'hf0;
  assign buff[157] = 8'h90;
  assign buff[158] = 8'h8;
  assign buff[159] = 8'h1;
  assign buff[160] = 8'h74;
  assign buff[161] = 8'h1;
  assign buff[162] = 8'hf0;
  assign buff[163] = 8'h2;
  assign buff[164] = 8'h0;
  assign buff[165] = 8'h62;
  assign buff[166] = 8'h75;
  assign buff[167] = 8'h82;
  assign buff[168] = 8'h0;
  assign buff[169] = 8'h22;
  wire [15:0] addr0 = addr;
  wire [15:0] addr1 = addr+1;
  wire [15:0] addr2 = addr+2;
  wire [15:0] addr3 = addr+3;
  wire [7:0] data_o0 = (addr0 < 170) ? buff[addr0] : 8'hxx;
  wire [7:0] data_o1 = (addr1 < 170) ? buff[addr1] : 8'hxx;
  wire [7:0] data_o2 = (addr2 < 170) ? buff[addr2] : 8'hxx;
  wire [7:0] data_o3 = (addr3 < 170) ? buff[addr3] : 8'hxx;
